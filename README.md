...
- :material-download: **[Installation](installation.md)** — dependencies and setup
- :material-play: **[Usage](usage.md)** — run the pipeline on a subject
- :material-file-tree: **[Outputs](outputs.md)** — what PARS produces
- :material-cog: **[How PARS works](workflows.md)** — the scientific method
- :material-chart-box: **[Evaluation](evaluation.md)** — quality, timestep, volume, validation
